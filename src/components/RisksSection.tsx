  ...
  const risks = [
    {
      ...
      amount: "до 800 000 ₽",
      description:
        "Нарушение требований пожарной безопасности влечет крупные штрафы для юридических лиц",
      color: "text-red-500",
    },
    {
      icon: "Building",
      ...
      amount: "до 90 суток",
      description:
        "При серьезных нарушениях МЧС может полностью остановить работу предприятия",
    ...
    },
    {
      ...
      amount: "до 50 млн ₽",
      description:
        "Неисправные системы не смогут предотвратить или локализовать возгорание",
      color: "text-red-600",
    },
    {
      icon: "Scale",
      ...
      amount: "до 7 лет",
      description:
        "При пожаре с пострадавшими руководство может понести уголовную ответственность",
      color: "text-red-700",
    },
  ];
